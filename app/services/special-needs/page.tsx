...
import { Heart, CheckCircle, Calendar, Clock, Shield, Sparkles } from 'lucide-react';
import Link from 'next/link';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Special Needs Care | i-Care Paediatric Dentistry',
  description: 'Specialized dental care for children with special needs. Compassionate and accommodating treatment approach.',
};
