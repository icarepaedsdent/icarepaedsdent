...
export const metadata: Metadata = {
  ...
  description:
    "Safe and gentle tooth extractions for children. We prioritize your child's comfort with sedation options available when needed.",
};
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              While we always aim to save teeth whenever possible, sometimes
              extractions are necessary for your child&apos;s dental health.
            </p>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          <Card className="p-6 bg-gradient-to-br from-white to-teal-50/30 border-teal-200 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div
                className="absolute -top-2 -right-2 w-16 h-16 bg-teal-100/40 rounded-full animate-pulse"
                style={{ animationDuration: '6s' }}
              ></div>
              <div
              ...
              ></div>
              <div
                className="absolute top-4 right-8 w-4 h-4 bg-teal-400/60 rounded-full animate-ping"
                style={{ animationDuration: '4s' }}
              ></div>
              <div
                className="absolute bottom-8 left-6 w-2 h-2 bg-emerald-400/70 rounded-full animate-ping"
                style={{ animationDuration: '3s' }}
              ></div>
              <div
                className="absolute top-12 right-16 text-teal-300/20 text-lg animate-spin"
                style={{ animationDuration: '25s' }}
              >
                +
              </div>
            ...
            <p className="text-gray-600 mb-6 relative z-10">
              Our policy at i-Care paediatric dentistry is to save all teeth
              whenever possible, but there are occasions when an extraction may
          ...
          <Card className="p-6 bg-gradient-to-br from-white to-emerald-50/30 border-emerald-200 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div
                className="absolute -top-1 -left-2 w-14 h-14 bg-emerald-100/40 rounded-full animate-bounce"
                style={{ animationDuration: '7s' }}
              ></div>
              <div
                className="absolute -bottom-1 -right-2 w-10 h-10 bg-teal-200/50 rounded-full animate-pulse"
                style={{ animationDuration: '5s' }}
              ></div>
              <div
                className="absolute top-6 left-8 w-3 h-3 bg-emerald-400/60 rounded-full animate-ping"
                style={{ animationDuration: '4s' }}
              ></div>
              <div
                className="absolute bottom-10 right-6 w-1 h-1 bg-teal-400/80 rounded-full animate-ping"
                style={{ animationDuration: '3s' }}
              ></div>
              <div
                className="absolute top-16 left-20 text-emerald-300/20 text-sm animate-spin"
            ...
            <p className="text-gray-600 mb-4 relative z-10">
              Our policy at i-Care Paediatric Dentistry is to save all teeth
              whenever possible, but there are occasions when an extraction may
              be necessary. These reasons include: Extensive decay, tooth ache,
              abscessed teeth, severely chalky molars, and orthodontic reasons.
            </p>
            <p className="text-gray-600 relative z-10">
              We also understand that the thought of tooth removal can an
              overwhelming experience for you and your child. A/Prof Sobia will
              guide you on how to best prepare your child for the procedure. If
              your child struggles to cooperate in the chair sedation options
              are also available.
            </p>
          </Card>
        </div>
        ...
        <div className="bg-teal-600 rounded-2xl p-8 text-center text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div
              className="absolute top-1/3 right-6 text-teal-400/20 text-sm animate-spin"
              style={{ animationDuration: '30s' }}
            >
              +
            </div>
          ...
          <p className="text-xl mb-6 text-teal-100 relative z-10">
            Contact us today to book a consultation and give your child the best
            dental care
          </p>
