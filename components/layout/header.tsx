  ...
  const aboutItems = [
    {
      ...
      href: '/about',
      description: "Learn about A/Prof Sobia's background and expertise",
    },
    {
    ...
    >
      <div
        className={cn(
          ...
          isScrolled ? 'mx-6 md:mx-12 lg:mx-16 xl:mx-20 2xl:mx-32' : 'mx-0'
        )}
      >
        <div
          className={cn(
                  ...
                  Parental Portal
                    ...
                    <div className="pt-6 space-y-3">
                      <Link href="tel:36230000">
                        <Button
                          variant="outline"
                          className="w-full mb-2 sm:text-xs"
                        >
                          <Phone className="h-4 w-4 mr-2" />
                          Call Now
                        </Button>
